...
urlpatterns = [
    ...
    path('input/deposit/', views.EntryOfConsumptionProductIntoStockView.as_view(), name="input-product-deposit"),
    path('output/deposit/', views.OutputOfConsumptionProductIntoStockView.as_view(), name="output-product-deposit"),
